...
describe(E2ETestRunner, () => {
    ...
    it('Initializes test scenarios and runs all tests', async () => {
        ...
        testPhaseRunnerMock.setup((t) => t.finalizeTestRun()).verifiable();
    ...
    function setupTestScenarioDriverFactory(): void {
        testScenarioDriverFactoryMock
            .setup((t) => t(testScenarioA, loggerMock.object, setupHandlerMock.object, testPhaseRunnerMock.object))
            .returns(() => testScenarioADriverMock.object);
        testScenarioDriverFactoryMock
            .setup((t) => t(testScenarioB, loggerMock.object, setupHandlerMock.object, testPhaseRunnerMock.object))
